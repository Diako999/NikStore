<template>
  ...
  >
    <div class="container-main flex items-center h-11 gap-1">
      ...
      <NuxtLink
        ...
        :class="[
          ...
          isLinkActive(link)
            ...
            : 'text-glass-text-secondary hover:text-brand hover:bg-brand/10',
        ]"
      >
        {{ link.label }}
      </NuxtLink>
      ...
      <!-- Divider -->
      <div class="mx-1.5 h-4 w-px rounded-full flex-shrink-0" style="background-color: var(--glass-border);" />
      ...
      <div class="flex items-center gap-0.5 flex-1">
        ...
        >
          <NuxtLink
            ...
            :class="[
              ...
              hoveredId === cat._id
                ...
                : 'text-glass-text-secondary font-medium hover:text-glass-text-primary hover:bg-brand/5',
            ]"
          >
            ...
            <svg
              ...
              :class="hoveredId === cat._id ? 'rotate-180 text-brand' : 'text-glass-text-disabled'"
          ...
          >
            ...
            <div class="nav-drop-panel rounded-2xl shadow-2xl">
