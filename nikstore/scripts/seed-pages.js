 ...
 * Run from nikstore/ directory:  node scripts/seed-pages.js
 */
...
const pages = [
  {
    title: 'درباره ما',
    slug: 'about',
    excerpt: 'آشنایی با فروشگاه استورین، مرجع پوشاک زنانه، مردانه و بچگانه ایران',
    status: 'published',
    order: 0,
    metaTitle: 'درباره استورین',
    metaDescription: 'استورین، فروشگاه تخصصی پوشاک زنانه، مردانه و بچگانه با گارانتی اصالت کالا',
    content: '<h2>درباره استورین</h2><p>استورین یک فروشگاه تخصصی پوشاک است که با هدف ارائه بهترین برندهای معتبر لباس زنانه، مردانه و بچگانه در ایران فعالیت می‌کند.</p><h2>ماموریت ما</h2><p>ما معتقدیم که هر کسی حق دارد از بهترین محصولات با کیفیت استفاده کند. به همین دلیل تمامی محصولات ما دارای گواهی اصالت و گارانتی معتبر هستند.</p><h2>چرا استورین؟</h2><ul><li><p>بیش از ۵۰۰ مدل پوشاک از برندهای معتبر جهانی</p></li><li><p>ضمانت ۷ روزه بازگشت کالا</p></li><li><p>ارسال سریع به سراسر کشور</p></li><li><p>پشتیبانی آنلاین و حضوری</p></li></ul><p>پشت استورین، تیمی از متخصصان طراحی مد و تجربه کاربری قرار دارند که هر روز تلاش می‌کنند تجربه خرید شما را بهتر کنند.</p>',
  },
  {
    title: 'تماس با ما',
    slug: 'contact',
