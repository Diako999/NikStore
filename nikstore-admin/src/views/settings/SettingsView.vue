...
const socialPlatforms = [
  { key: 'instagram', icon: '📷', label: 'اینستاگرام', placeholder: 'https://instagram.com/nikstore' },
  { key: 'telegram',  icon: '✈️', label: 'تلگرام',     placeholder: 'https://t.me/nikstore' },
  { key: 'twitter',   icon: '🐦', label: 'توییتر / X',  placeholder: 'https://x.com/nikstore' },
  { key: 'whatsapp',  icon: '💬', label: 'واتساپ',      placeholder: 'https://wa.me/989...' },
  { key: 'linkedin',  icon: '💼', label: 'لینکدین',     placeholder: 'https://linkedin.com/company/nikstore' },
  { key: 'youtube',   icon: '▶️', label: 'یوتیوب',     placeholder: 'https://youtube.com/@nikstore' },
]
...
const emptyForm = () => ({
  ...
  sms: {
    ...
    kavenegarApiKey:      '',
    kavenegarSender:      '',
    kavenegarOtpTemplate: 'nikstore-otp',
  },
  trustItems: [
...
function applyData(data) {
  Object.assign(form, {
    ...
    sms: {
      ...
      kavenegarOtpTemplate: data.sms?.kavenegarOtpTemplate ?? 'nikstore-otp',
    },
